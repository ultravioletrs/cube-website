...
permissions, configuration, and available models. Guardrails are applied per domain, ensuring strong isolation and access control between different workspaces.
...
This section explains how to create, configure, publish, and activate guardrails
directly from the Cube AI user interface.
...
1. Configure the guardrail using the available tabs:

- **General Config**
- **Conversational Colang**
- **Prompts**

1. Use the **Preview / Helper** panel to:

- validate configuration syntax
- insert predefined configuration examples

1. Click **Create Guardrail** to save the initial configuration.
...
1. Locate the **Versions** section.
1. Click **Activate** next to the desired version.
